...
function comparePaperTitles (paper1, paper2) {
  ...
  console.log("noiseless1: " + noiseless1);
  console.log("noiseless2: " + noiseless2);
...
[
 ...
 {title: "Blocks at Your Fingertips: Blurring the Line Between Blocks and Text in GP", 
  ...
  authors: [{first: "Jens", 
             ...
             email: "jens@moenig.org", 
             country: "Germany", 
             org: "Communications Design Group, SAP"}, 
           {first: "Yoshiki", 
            last: "Ohshima", 
            email: "Yoshiki.Ohshima@acm.org", 
            country: "United States of America", 
 ...
 {title: "Scratch Data Blocks: Providing an API to the Scratch online community from within Scratch", 
  number: 49,  
  type: "position", 
